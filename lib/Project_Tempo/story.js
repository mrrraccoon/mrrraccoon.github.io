...
const storyRand2 = "<div id='copy-output' class='w3-container w3-animate-zoom'><h1>The Great Unknown!!</h1><br><h4>The Great Unknown is your place to play. Create random sentences all you like. <br> <form><input type='text' width='85' height='75'></form>"

/* -------------------------- button click version -------------------------- */

const story02b = "<div id='copy-output' class='w3-container w3-animate-zoom'><h1>The Great Unknown!!</h1><br><h4>The Great Unknown is your place to play. Create random sentences all you like. <br> <form><input type='text' width='85' height='75'></form>"
