...
const storyRand3 = "<div id='copy-output' class='w3-container w3-animate-zoom'><h1> The Ant Hill</h1> <h4>The little ant followed a string of ants along the ground towards the <button id='noun0301' class='w3-button-trans w3-border-0' onclick='firstNoun()'><i><u>noun</u></i></button>. <br>It was following a scent-marked path back home.<br>The <button id='adj0301' class='w3-button-trans w3-border-0' onclick='firstAdj()'><i><u>adjective</u></i></button> clouds loomed in the distance.<br>Suddenly, there came a <button id='adj0302' class='w3-button-trans w3-border-0' onclick='secondAdj()'><i><u>adjective</u></i></button> from the clouds. A storm was brewing!<br>The little <button id='noun0302' class='w3-button-trans w3-border-0' onclick='secondNoun()'><i><u>noun(s)</i></u></button> must hurry if they are to make it inside!<br>The storm rushes in but the <button id='noun0303' class='w3-button-trans w3-border-0' onclick='thirdNoun()'><i><u>noun</i></u></button> made it inside the hill and are safe for another day.</p></div>"
